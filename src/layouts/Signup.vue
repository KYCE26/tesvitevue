<template>
    <div class="flex flex-col min-h-screen">
      ...
      <main class="flex-1 bg-gray-100 dark:bg-gray-900">
        <section class="flex flex-col bg-white items-center justify-center px-6 py-8 mx-auto h-screen md:h-screen lg:h-screen">
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <span
                      ...
                      class="absolute inset-y-3 right-0 flex items-center px-2 focus:outline-none text-gray-500 cursor-pointer dark:text-gray-400 ml-2"
                    >
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <span
                      ...
                      class="absolute inset-y-3 right-0 flex items-center px-2 focus:outline-none text-gray-500 cursor-pointer dark:text-gray-400 ml-2"
                    >
                      <i :class="confPassword ? 'fas fa-eye' : 'fas fa-eye-slash'"></i>
                    </span>
                  </div>
                </div>
