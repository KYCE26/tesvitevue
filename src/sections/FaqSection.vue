    ...
    <div id="faq" class="container mx-auto px-5 md:w-4/5">
        <section class="py-16 pt-18">
            <div class="w-4/5 md:w-3/5 mx-auto">
                ...
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">Berikut ini beberapa FAQ kami. Jika Anda memiliki pertanyaan lain yang ingin Anda jawab, jangan ragu untuk mengirim email kepada kami.</p>
            </div>
